    ...
    Picker.prototype = {
        ...
        _renderPop: function () {
            ...
            if (cols && !qs('#cover') && !qs('#picker')) {
                ...
                this.picker.innerHTML = '<div class="picker-header"><span class="cancel">Cancel</span><span class="confirm">OK</span></div><div class="picker-items">' + cols + '<div class="picker-line picker-line-top"></div><div class="picker-line picker-line-bottom"></div></div>';
        ...
        _setOffset: function (el, index, n, isTouchEnd) {
            ...
            if (isiOS) {
                el.querySelector('.picker-items-col-wrapper').style.cssText = '-webkit-transition:' + time + '; transition:' + time + '; -webkit-transform: translateY(' + (this._height * 6 / 2 - this._height / 2 - n) + 'px); transform: translateY(' + (this._height * 6 / 2 - this._height / 2 - n) + 'px)';
            } else {
                el.querySelector('.picker-items-col-wrapper').style.cssText = '-webkit-transition:' + time + '; transition:' + time + '; -webkit-transform: translate3d(0, ' + (this._height * 6 / 2 - this._height / 2 - n) + 'px, 0); transform: translate3d(0, ' + (this._height * 6 / 2 - this._height / 2 - n) + 'px, 0)';
            }
